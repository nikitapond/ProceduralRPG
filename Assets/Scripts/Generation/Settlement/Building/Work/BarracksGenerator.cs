...
public class BarracksGenerator
{
    ...
    public static Barracks GenerateBarracks(GenerationRandom genRan, Barracks barr, out BuildingVoxels vox)
    {
        ...
        BuildingGenerator.ChooseEntrancePoint(genRan, vox, barr);
