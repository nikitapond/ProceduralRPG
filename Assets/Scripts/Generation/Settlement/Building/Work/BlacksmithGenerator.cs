...
public class BlacksmithGenerator
{
    ...
    private static void ChooseLShapedWall(GenerationRandom genRan, Blacksmith smith)
    {
        ...
        int xDir = (wallPoints[deltaPointI].x == 0 ? 1 : -1) * genRan.RandomInt(smith.Width / 4, smith.Width - smith.Width / 4);
        int zDir = (wallPoints[deltaPointI].z == 0 ? 1 : -1) * genRan.RandomInt(smith.Height / 4, smith.Height - smith.Height / 4);
