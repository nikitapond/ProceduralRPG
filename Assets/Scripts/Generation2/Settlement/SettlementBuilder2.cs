...
public class SettlementBuilder2 : BuilderBase
{
    ...
    private void PlaceLargeBuildings()
    {
        ...
        {
            List<BuildingPlan> remaining = new List<BuildingPlan>();
            foreach(BuildingPlan bp in Shell.RequiredBuildings)
            {
                if(bp.MinSize >= 32)
                {
                    buildings.Add(bp);
            ...
            Shell.RequiredBuildings = remaining;
        }
    ...
    private List<Plot> FindPlots(int pathCornerSearch = 8)
    {
